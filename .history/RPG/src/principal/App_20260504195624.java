...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        switch(opt0){
            ...
            case 4: 
                ...
                inGame(mago, paladino, barbaro, bardo);
                break;
            default:
    ...
    public static void inGame(Mago mago, Paladino paladino, Barbaro barbaro, Bardo bardo){
        Scanner sc = new Scanner(System.in);
